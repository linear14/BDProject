...
object Licenses {
    ...
    private val kotlinLicense = License(
        "Kotlin",
        "https://github.com/JetBrains/kotlin",
        apacheLicense
    )

    private val cardViewLicense = License(
        "CardView",
        "https://developer.android.com/jetpack/androidx/releases/cardview",
        apacheLicense
    )

    private val roomLicense = License(
        "Room",
        "https://developer.android.com/jetpack/androidx/releases/room",
        apacheLicense
    )

    private val coroutineLicense = License(
        "Coroutine",
    "https://github.com/Kotlin/kotlinx.coroutines",
        apacheLicense
    )

    private val koinLicense = License(
        "Koin",
        "https://github.com/InsertKoinIO/koin",
        apacheLicense
    )

    private val flexBoxLicense = License(
        "FlexBox",
        "https://github.com/google/flexbox-layout",
        apacheLicense
    )

    private val activityLicense = License(
        "Activity",
        "https://developer.android.com/jetpack/androidx/releases/activity",
        apacheLicense
    )

    private val fragmentLicense = License(
        "Fragment",
        "https://developer.android.com/jetpack/androidx/releases/fragment",
        apacheLicense
    )

    private val navigationLicense = License(
        "Navigation Components",
        "https://developer.android.com/jetpack/androidx/releases/navigation",
        apacheLicense
    )

    private val tedKeyBoardObserverLicense = License(
        "TedKeyBoardObserver",
        "https://github.com/ParkSangGwon/TedKeyboardObserver\nCopyright 2019 Ted Park",
        apacheLicense
    )

    private val lifeCycleLicense = License(
        "Lifecycle",
